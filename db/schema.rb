...
ActiveRecord::Schema.define(version: 20160314085411) do
  ...
  add_index "project_types", ["slug"], name: "index_project_types_on_slug", unique: true, using: :btree
  ...
  add_index "subcategories", ["categories_id"], name: "index_subcategories_on_categories_id", using: :btree
  ...
  create_table "super_admin_comentarios", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
